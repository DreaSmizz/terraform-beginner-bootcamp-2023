...
class Home
  ...
  # very similar and in most cases idential validation
  ...
  # we will make sure it is in incremental version in the controller.
...
class TerraTownsMockServer < Sinatra::Base
  ...
  # return a hard coded access code
  def x_access_code
    return var.terratowns_access_token
  end

  def x_user_uuid
    return var.teacherseat_user_uuid
  end
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # puts will print to the terminal similar to  a print or a console.log
    ...
    # to see or debug what we can input to this endpoint
    puts "name #{name}"
    ...
    # return the errors
    unless home.valid?
      # return the errors message back in json
  ...
  # UPDATE
  # very to similar to create action
